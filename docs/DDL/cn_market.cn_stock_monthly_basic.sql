-- cn_market.cn_stock_monthly_basic
-- Month-end stock valuation / market-cap snapshots.

CREATE TABLE IF NOT EXISTS `cn_stock_monthly_basic` (
    ...
    KEY `idx_cn_stock_monthly_basic_month_key` (`month_key`),
    KEY `idx_cn_stock_monthly_basic_trade_date` (`trade_date`),
    KEY `idx_cn_stock_monthly_basic_total_mv` (`trade_date`, `total_mv`),
    KEY `idx_cn_stock_monthly_basic_circ_mv` (`trade_date`, `circ_mv`)
