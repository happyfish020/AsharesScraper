...
proc: BEGIN
    ...
    SET v_trade_date = (SELECT MAX(trade_date) FROM cn_stock_daily_price);

    IF v_trade_date IS NULL THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'SP_BUILD_SECTOR_ROTATION_SIGNAL_LATEST: trade_date is NULL';
    END IF;
