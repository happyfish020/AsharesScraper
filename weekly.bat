...
if "%V8_WEEKLY_TASKS%"=="" set "V8_WEEKLY_TASKS=v8_stock_basic event_periodic v8_weekly_audit_market v8_weekly_finalize"
...
REM   4) v8_weekly_finalize    -> latest leader snapshot; crosswalk latest disabled
REM
