...
BOARD_INDUSTRY_TABLE = "cn_board_industry_daily_em"
BOARD_CONCEPT_TABLE = "cn_board_concept_daily_em"
BOARD_FAILURE_TABLE = "cn_board_fetch_failures"
