...
from app.utils.oracle_utils import get_engine
...
class CoverageAuditTask:
    ...
    def run_full_coverage_audit(self,
        ...
        """
        cfg = self.ctx.config
        base_index = "sh000001"  # 或 "sh000001"
    ...
    def audit_stock_missing_days(
        ...
        if stock_symbols is None:
            ...
            all_symbols_df = pd.read_sql(symbol_query, get_engine())
        ...
        for i in range(0, len(stock_symbols), batch_size):
            ...
            """
            try:
                batch_df = pd.read_sql(query, get_engine())
