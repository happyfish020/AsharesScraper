...
D:\Lhj\PythonWS\MarketScraper\AsharesScraperV2\.venv\Scripts\python D:\Lhj\PythonWS\MarketScraper\AsharesScraperV2\runner.py  --tasks index,audit --days 10 --refresh
